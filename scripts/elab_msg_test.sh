...
# ===============================================================================
echo "***************************************************************"
echo 'Elab_msg_test.sh: inizio elab ' `date +"%Y-%m-%d %H:%M"`
...
scp $MSGDIR_IMG/EIR_108_ZOOM_$dataora.png  meteo@$ECCELLENTE:/srv/www/prodottimeteo/msg1/E-IR108-ZOOM
scp $MSGDIR_IMG/IR_$dataora.png  meteo@$ECCELLENTE:/srv/www/prodottimeteo/msg1/E-IR108
scp $MSGDIR_IMG/WV_$dataora.png  meteo@$ECCELLENTE:/srv/www/prodottimeteo/msg1/E-WV62
scp $MSGDIR_IMG/NATCOL_$dataora.png  meteo@$ECCELLENTE:/srv/www/prodottimeteo/msg1/NATCOL
scp $MSGDIR_IMG/AIRMASS_$dataora.png  meteo@$ECCELLENTE:/srv/www/prodottimeteo/msg1/AIRMASS
scp $MSGDIR_IMG/AVHRR_$dataora.png  meteo@$ECCELLENTE:/srv/www/prodottimeteo/msg1/AVHRR
scp $MSGDIR_IMG/SOLARDAY_$dataora.png  meteo@$ECCELLENTE:/srv/www/prodottimeteo/msg1/SOLARDAY
scp $MSGDIR_IMG/FIRE_$dataora.png  meteo@$ECCELLENTE:/srv/www/prodottimeteo/msg1/FIRE
scp $MSGDIR_IMG/MICRO24H_$dataora.png  meteo@$ECCELLENTE:/srv/www/prodottimeteo/msg1/MICRO24H
