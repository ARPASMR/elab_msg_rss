...
// INTERFACES:
	...
	, m_nWTlevels		(i_nWTlevels		)
	, m_PredMode		(i_PredMode			)
	, m_BlockMode		(i_BlockMode		)
	, m_nLossyBitPlanes	(i_nLossyBitPlanes	)
...
class CCompressWT :		public COMP::CCompress
					,	public COMP::CWTParams
{
