...
GtkWidget *Create_Dlist(char *name,...)        /* name of clist */
{
  ...
  wl=Create_Clist(Dlist_LeftID,  Dlist_Selleft,Dlist_Unselleft,NULL,ncol,
                                 title[0],width[0],
                                 title[1],width[1],
                                 title[2],width[2],
                                 title[3],width[3],
  ...
  wr=Create_Clist(Dlist_RightID, Dlist_Selright,Dlist_Unselright,NULL,ncol,
                                 title[0],width[0],
                                 title[1],width[1],
                                 title[2],width[2],
                                 title[3],width[3],
